function [spikepos, out_] = testfoo(in,SaRa,params)
...
%       params:%           wavelet  : Wavelet (Default: 'sym4')
...
%parse inputs
[params,s,fs] = parseInput(in,SaRa,params);
...
%internal functions:
%--------------------------------------------------------------------------
function [params,s,fs] = parseInput(in,SaRa,params)
