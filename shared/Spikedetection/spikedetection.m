...
%     end
   ...
   % further analysis (main-array: SPIKES)
    ...
    [SPIKEZ.AMP]=getSpikeAmplitudes(raw,SPIKES,SaRa);
    [SPIKEZ.neg.AMP]=getSpikeAmplitudes(raw,SPIKES_neg,SaRa);
    [SPIKEZ.pos.AMP]=getSpikeAmplitudes(raw,SPIKES_pos,SaRa);
