...
private:
    ...
    std::vector<double> AdaptiveSynchro(int spiketrain,double T1,double T2,double T3,double T4,double threshold);
    ...
    double AdaptiveCoincidence(int NthSpike, int STindex1, int STindex2,double maxwindow,double threshold);
...
public:
    ...
    double AdaptiveSPIKEsynchro(double start,double end ,double T1,double T2,double threshold);
    
    std::vector< std::vector<double> > AdaptiveSPIKEsynchroProfile(double start, double end,double T1,double T2,double threshold);
