...
function [Sync]=SyncMeasure_SpikeDistance(TS,rec_dur, flag_profile) 
    ...
    %% 0) Init
    Sync.S=NaN;
    Sync.PREF.method='SPIKE-Distance';
    ...
    D=STS.SPIKEdistance();
    if flag_profile 
        Sync.PREF.P = STS.SPIKEdistanceProfile(); 
        Sync.PREF.M = STS.SPIKEdistanceMatrix();
    end 
