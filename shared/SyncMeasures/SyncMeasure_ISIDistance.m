...
function [Sync]=SyncMeasure_ISIDistance(TS,rec_dur, flag_profile) 
    ...
    D=STS.ISIdistance();
    if flag_profile 
        Sync.PREF.P = STS.ISIdistanceProfile(); 
        Sync.PREF.M = STS.ISIdistanceMatrix();
    end 
