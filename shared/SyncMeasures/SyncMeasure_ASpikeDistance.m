...
function [Sync]=SyncMeasure_ASpikeDistance(TS,rec_dur, flag_profile) 
    ...
    %% 0) Init
    Sync.S=NaN;
    Sync.PREF.method='A-SPIKE-distance';
    ...
    D=STS.AdaptiveSPIKEdistance();
    if flag_profile 
        Sync.PREF.P = STS.AdaptiveSPIKEdistanceProfile(); 
        Sync.PREF.M = STS.AdaptiveSPIKEdistanceMatrix();
    end 
