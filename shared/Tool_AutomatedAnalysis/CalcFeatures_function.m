...
function [WIN,MERGED]=CalcFeatures_function(MERGED,Selection,time_win,FR_min,N,binSize)
...
for i=1:size(WIN,2) % loop trough all windows (=files)
    ...
    if any(strcmp('Cardio - Propagation Velocity',Selection))
        ...
        [velocity_airline,velocity_min_mean,velocity_max_mean,velocity_mean_mean] = cardioCalculateSpeed(WIN(i).SPIKEZ);
